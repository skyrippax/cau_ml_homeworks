...
class KNearestNeighbor:
    ...
    def predict(self, X, k=1, num_loops=0):
        ...
        if number_loops == 0:
            ...
            raise ValueError('Invalid value %d for number_loops' % number_loops)
    ...
    def compute_distances_two_loops(self, X):
        ...
        for i in range(num_test):
            for j in range(num_train):
                ...
                distance[i, j] = np.sqrt(np.sum((X[i] - self.X_train[j])**2))
    ...
    def compute_distances_one_loop(self, X):
        ...
        for i in range(num_test):
            ...
            #######################################################################
            # *****START OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
            distance[i] = np.sqrt(np.sum((X[i] - self.X_train)**2, axis=1))
            # *****END OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
        return distance
    ...
    def compute_distances_no_loops(self, X):
        ...
        distance_squared = sum_test[:, np.newaxis] - 2 * dot_product + sum_train
